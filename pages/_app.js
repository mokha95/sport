...
// le fichier app est le point d'entrée principal et gère l'authentification pour voir(si un utilisateur est autorisé à accéder à certaines pages si il est connecté ou pas)
export default App;
...
function App({ Component, pageProps }) {
  ...
  return (
    <>
      ...
      <Header />
      {/* si l utilisateur est connecté affiche la div en blanc si il nest pas connecté affiche rien  */}
      <div className={`app-container ${user ? "bg-light" : ""}`}>
        ...
        />
        {/* si l utilisateur est autoriser le composant est rendu sinon il ne l est pas */}
