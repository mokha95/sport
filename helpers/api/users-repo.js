...
async function authenticate({ email, password }) {
  ...
  // verifie si l utilisateur existe et si le mot de passe fourni correspond au mot de passe haché en base de données.
...
// bcrypt" est en effet utilisé dans la fonction de création (create) pour hacher le mot de passe lors de l'ajout d'un nouvel utilisateur.
